...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-br from-[#26143f] to-black border-t border-gray-800/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 !gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 leading-relaxed !mb-6">
              ...
              management, and career insights. Stay organized and land your
              dream job faster.
            </p>
            <div className="flex !gap-6">
              {[
                ...
                <a
                  key={index}
                  href={social.href}
                  className="w-10 h-10 bg-gray-800/50 hover:bg-purple-500/20 border
                   border-gray-700 hover:border-purple-500 rounded-lg flex 
