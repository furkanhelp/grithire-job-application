const FormRow = ({ type, name, labelText, defaultValue = "" }) => {
  return (
    ...
    !py-4 border-b border-gray-100 dark:border-gray-700 bg-gradient-to-r
     from-[#26143f] to-black"
    >
      {/* Label Column */}
      ...
      <div className="lg:col-span-2  ">
        {type === "select" ? (
          ...
          <input
            ...
            name={name}
            defaultValue={defaultValue}
            className="w-full bg-gradient-to-r from-[#26143f] to-black px-4 py-3 border border-gray-300
             dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2
